...
本项目是 **月度员工绩效考核管理系统**，采用主流 Java Web 技术栈开发，功能完整、结构清晰，非常适合作为毕业设计或课程设计的参考源码。

**仓库名**：`java-project-009-yue-du-yuan-gong-xiao-kao-he-guan-li`

**原始压缩包名**：`springboot009月度员工绩效考核管理系统`
